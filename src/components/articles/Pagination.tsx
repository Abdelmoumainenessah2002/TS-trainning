    ...
    <div className="flex items-center justify-center mt-2 mb-10">
      ...
      {pagesArray.map((page) => (
        <Link
          ...
          key={page}
          className={` ${pageNumber === page ? "bg-gray-400" :""} mx-2 border border-gray-700 text-gray-700 rounded-md py-1 px-3 text-xl cursor-pointer hover:bg-gray-200 transition`}
        >
          {page}
        </Link>
      ))}
